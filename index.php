...
<section class="features">
    ...
    <div class="feature">
        <h3>&#128231; Email Verification &amp; OAuth</h3>
        <p>Supports secure email token verification, single-use password resets, and Google OAuth 2.0 single sign-on integration.</p>
    </div>
    <div class="feature">
        <h3>&#128737; Session Protection</h3>
        <p>Session IDs are regenerated after login to defeat fixation, and cookies are hardened with
        <code>HttpOnly</code> and <code>SameSite=Lax</code>.</p>
    </div>
    <div class="feature">
        <h3>&#128680; SQL Injection &amp; XSS Proof</h3>
        <p>All database queries use prepared statements, and all outputs are
